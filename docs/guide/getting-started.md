...
- [Output Formats](/guide/output-formats) - PTX, TOON-strict, Markdown, and XML formats
- [Relevance Filtering](/guide/relevance-filtering) - Smart file prioritization
- [Configuration](/reference/configuration) - Customize behavior
- [File Filtering](/guide/file-filtering) - Advanced filtering rules
